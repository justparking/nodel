...
//                    continue;
//                
//                System.out.format("%s ('%s', ips:%s)%n", ni.getName(), ni.getDisplayName(), Collections.list(ni.getInetAddresses()));
//            }
//            
//            MulticastSocket ms = new MulticastSocket(new InetSocketAddress("192.168.178.24", 0));
//            //MulticastSocket ms = new MulticastSocket();
//            //ms.bind(new InetSocketAddress("192.168.178.24", 0));
//            //ms.setNetworkInterface(NetworkInterface.getByName("wlan1"));
//            
//            System.console().printf("Waiting%n...");
//            System.in.read();
